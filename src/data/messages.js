export const messages = {
  sections: [
    ...
    {
      title: "❤️ Proposal & Commitment (19 September 2023)",
      content:
    ...
    {
      title: "📸 First Picture Together (8 December 2023)",
      content:
    ...
    },
    {
      ...
      content:
        "I cherished every little thing with you. Every small physical touch felt magical — a warmth I had never known before. Whenever we fought, I would still end up craving for you.",
      image: "/image5.jpg",
      type: "memory",
    },
    {
      title: "⚡ Challenges",
      content:
        "But love is not always easy. Sometimes, jealousy crept in — little things that hurt me. Misunderstandings grew, and every small fight felt heavier than it should.",
      image: "/image6.jpg",
      type: "story",
    },
    {
    ...
    {
      title: "🌹 Memories Today",
      content:
        "Even after everything, my heart still goes back to those days — your laughter, your innocence, the way you made me feel alive. We may not talk now, but Shivani, you will always be the most beautiful part of my story.",
      image: "/image8.jpg",
      type: "memory",
    },
  ],
